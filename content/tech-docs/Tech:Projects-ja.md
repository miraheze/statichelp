...
---
 ...
 `{{ {{Tech navigation|projects|header=Technology Team Projects|description=<span class="mw-translate-fuzzy">Mirahezeのシステム管理者は常にさまざまなことを計画しています。現在のMirahezeのプロジェクトについて知りましょう。</span>|keywords=tech projects, miraheze tech projects}} }}`
...
----
**[Go to Source &rarr;](https://meta.miraheze.org/wiki/Tech:Projects/ja)**
...
Login to [mwtask181](/tech-docs/techmwtask181.md), then run these commands.
...
## Upgrading Extension 
 ...
 `{{ {{Note}} }}`*These steps are not yet confirmed but are theoretically how it should work. It should first be tested on [test151](/tech-docs/techtest151.md) before attempted in production.*
...
* Run puppet on [mwtask181](/tech-docs/techmwtask181.md) and [test151](/tech-docs/techtest151.md)
* Run `mwdeploy --world --versions=all --servers=all` on [mwtask181](/tech-docs/techmwtask181.md) and [test151](/tech-docs/techtest151.md)

...
Since Semantic MediaWiki is installed via composer, the staging folder is not a git repository. Instead of `git am`, you have to use the `patch` command to apply a patch.
Example:

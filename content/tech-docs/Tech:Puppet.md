...
*This section is only a part of the installation process, see [Tech:Server lifecycle](Tech:Server_lifecycle.md) for all steps.*
...
*This section is only a part of the decommission and reimage processes, see [Tech:Server lifecycle](Tech:Server_lifecycle.md) for all steps.*

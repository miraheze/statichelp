...
```
{{ {{Discussion
|comment=Closing as {{done|successful}}. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 06:12, 8 June 2026 (UTC)
|1=
Both '''[[mw:Skin:CologneBlue|CologneBlue]]''' and '''[[mw:Skin:Modern|Modern]]''' are old skins which rarely see usage. We demoted them from being globally enabled skins, but they are still enabled by default. The logical next step is to make these skins opt-in instead of opt-out on new wikis.
...
:{{support}}, Most questions about them in the Discord are about disabling them. - [[User:JaneBuzJane|JaneBuzJane]] ([[User talk:JaneBuzJane|talk]]) 19:16, 23 April 2026 (UTC)
:{{support}} per above. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 19:51, 23 April 2026 (UTC)
:{{oppose}} on the basis that a skin being enabled causes no change in behavior unless a user explicitly decides to select it. As someone who has set a non-default skin (legacy vector) as a global preference, I'll remind everyone that a user can only use a skin which has been enabled on the wiki, meaning that disabling a skin restricts user agency, which we should seek to maximize. — <span style="font-variant: small-caps">[[User:Chrs|chrs]] ([[User talk:Chrs|talk]])</span> 23:31, 23 April 2026 (UTC)
::Legacy Vector is globally enabled. If we're gonna talk about having skins enabled by default, why would those skins be cologne blue and modern over skins like cosmos and citizen? [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 23:58, 23 April 2026 (UTC)
:::I'd concur with you there, and would be willing to go so far as to say that almost every skin should be enabled globally or by default. — <span style="font-variant: small-caps">[[User:Chrs|chrs]] ([[User talk:Chrs|talk]])</span> 00:16, 24 April 2026 (UTC)
:{{support}} [[User:SomeRandomDeveloper|SomeRandomDeveloper]] ([[User talk:SomeRandomDeveloper|talk]]) 12:33, 24 April 2026 (UTC)
:{{abstain}} Meh, never cared much for either of those two skins, so you can do what you want with them. --[[User:DarkMatterMan4500|DarkMatterMan4500]] ([[User talk:DarkMatterMan4500|talk]]) ([[Special:Contributions/DarkMatterMan4500|contribs]]) 15:29, 24 April 2026 (UTC)
:{{Oppose}} (( As someone who may someday want to use a skin ... any skin, I would find it very helpful if it were to remain available ... The idea of opting in is a lot of work especially for the novice ... and the more we cut or reduce options, the harder it is to know what changed ... kind of makes it difficult for me as a user to know how things tied together ... It's extremely hard to open a discussion about something that is removed because I'd have to look elsewhere for words and examples ... <br> ... I'll be more than happy to revisit my stance if a more interesting point is brought up ... ... ... because I still find things useful even when they stop working ... so that reason won't convince me to remove ... )) --- [[User:Imamy|Imamy]] ([[User talk:Imamy|talk]]) 00:12, 25 April 2026 (UTC)
:{{Oppose}} Per above…… [[User:Himvat (GNF)|Himvat (GNF)]] ([[User talk:Himvat (GNF)|talk]]) 08:18, 30 April 2026 (UTC)
:{{support}} The default available skins should be sensible defaults, and I do not know that CologneBlue and Modern have kept up. I imagine they would clash with a lot of customized wikis as they exist. The skins should still be available but I don't think they should be default options. [[User:Harej|Harej]] ([[User talk:Harej|talk]]) 02:09, 1 May 2026 (UTC)
:{{Support}} These skins aren't used terribly often (we disabled them ourselves after a vote), and leaving unstyled/untouched skins open to be selected simply adds more burden on the admins (in case something is broken on them) without any tangible benefits. If folks want to actually use these skins, they're easy to enable after the fact. [[User:Emiliers|Emiliers]] ([[User talk:Emiliers|talk]]) 18:44, 1 May 2026 (UTC)
:{{support}} [[User:ark|ark]] ([[User talk:ark|talk]]) 07:23, 3 May 2026 (UTC)
:{{Support}} If it means reducing our servers workload (in a way). As Emiliers said, if the folk wants to use the skin, they can just easily er-enable it ~ [[User:Elisapoly|Elisapoly]] ([[User talk:Elisapoly|talk]]) 04:08, 10 May 2026 (UTC)
}} }}
```
...
```
{{ {{Discussion
|comment=Closing as {{done|successful}}. 12a is the favoured option. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 06:12, 8 June 2026 (UTC)
|1=
This was a suggestion of [[User:TheWWRNerdGuy]].

An update to the extension close to 2 years ago enabled animations by default for all wikis ([[phorge:T12350|T12350]]). The animation is slow and results in prolonged waiting for content to show up. An example of the scrolling animation can be seen on [https://publictestwiki.com/wiki/User:PetraMagna/TabberNeue Public Test Wiki]. In comparison, on [https://strinova.org/wiki/User:PetraMagna/TabberNeue a page with scrolling disabled], the user experience is much smoother.
...
:{{Support}} As proposer. I've been a hater of <code>$wgTabberNeueEnableAnimation</code> ever since [[phorge:T12350|T12350]]. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:24, 23 April 2026 (UTC)
:{{weak support}} I'm alright with the animation. However, it feels like it might screw with some lazyloading: if you have an image tabber, click on tab 1 and then tab 3, it might either load the images in tab 2, or display a blank tab. I haven't properly tested this scenario, though. [[User:KockaAdmiralac|KockaAdmiralac]] ([[User talk:KockaAdmiralac|talk]]) 18:18, 23 April 2026 (UTC)
:{{support}} per proposal. - [[User:JaneBuzJane|JaneBuzJane]] ([[User talk:JaneBuzJane|talk]]) 19:41, 23 April 2026 (UTC)
:{{support|strongest}} shouldn't be surprising since I was the one who suggested it but I hate the animation and the motion sickness it gives me. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 20:24, 23 April 2026 (UTC)
:{{support}} per above, bad upstream default. — <span style="font-variant: small-caps">[[User:Chrs|chrs]] ([[User talk:Chrs|talk]])</span> 00:22, 24 April 2026 (UTC)
:{{Abstain}} (( ... Skipping ... don't know how this works ... )) --- [[User:Imamy|Imamy]] ([[User talk:Imamy|talk]]) 01:50, 25 April 2026 (UTC)
:{{support}} The animation slows things down and isn't necessary. [[User:Harej|Harej]] ([[User talk:Harej|talk]]) 02:09, 1 May 2026 (UTC)
:{{Abstain}} I personally hate the animation, but I've seen a few editors who find it neat, so I don't want to yuck their yum. If there's a tech reason for wanting to disable this (e.g. performance improvements), then consider this a weak support instead. [[User:Emiliers|Emiliers]] ([[User talk:Emiliers|talk]]) 21:53, 1 May 2026 (UTC)
:{{support}} [[User:ark|ark]] ([[User talk:ark|talk]]) 07:40, 3 May 2026 (UTC)
:{{support|weak}} This might entirely be dependent on the users' preferences. Some don't like animation while some find it neat to see animation. I, for one, would support disabling it, albeit weak as I worry that disabling it might prompt questions from users in discord. ~ [[User:Elisapoly|Elisapoly]] ([[User talk:Elisapoly|talk]]) 04:20, 10 May 2026 (UTC)
:{{support|weak}} It does get irritating, especially when you don't even know which ones you want to use, and end up screwing something up by mistake. --[[User:DarkMatterMan4500|DarkMatterMan4500]] ([[User talk:DarkMatterMan4500|talk]]) ([[Special:Contributions/DarkMatterMan4500|contribs]]) 17:08, 16 May 2026 (UTC)
=== Discussion 12b ===
Please discuss disabling this option only for new wikis. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:07, 23 April 2026 (UTC)

:{{support|weak}} Same rationale as 7b. This is more work for the tech team compared with 12a. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:25, 23 April 2026 (UTC)
:{{oppose|weka}} in favor of 12a per {{no ping|PetraMagna}} and the fact that this discussion originated from a bad change to defaults by upstream. — <span style="font-variant: small-caps">[[User:Chrs|chrs]] ([[User talk:Chrs|talk]])</span> 00:25, 24 April 2026 (UTC)
:{{Oppose}} (( ... I really don't like the idea of troubleshooting issues that require knowledge of which wiki generation that a wiki came from ... I prefer apply to all or apply to none ... )) --- [[User:Imamy|Imamy]] ([[User talk:Imamy|talk]]) 01:53, 25 April 2026 (UTC)
:{{support}} The animation slows things down and isn't necessary. [[User:Harej|Harej]] ([[User talk:Harej|talk]]) 02:09, 1 May 2026 (UTC)
:{{Support}} Honestly, thinking about it a bit more, this might be a better option if disabling the animation is preferred, so it doesn't mess with a setting that existing wikis have probably gotten used to (if they haven't taken the opportunity to disable it already). [[User:Emiliers|Emiliers]] ([[User talk:Emiliers|talk]]) 04:36, 2 May 2026 (UTC)
:{{Support}} For new wiki, I support. If they want the animation, they could just easily enable it. ~ [[User:Elisapoly|Elisapoly]] ([[User talk:Elisapoly|talk]]) 04:20, 10 May 2026 (UTC)
:{{support|weak}} Per other people's opinions, in addition to the fact that this would probably be for the best in the long-term. --[[User:DarkMatterMan4500|DarkMatterMan4500]] ([[User talk:DarkMatterMan4500|talk]]) ([[Special:Contributions/DarkMatterMan4500|contribs]]) 17:08, 16 May 2026 (UTC)
}} }}
```
...
```
{{ {{Discussion
|comment=Closing as {{done|successful}}. 13a appears to be the favoured option. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 06:12, 8 June 2026 (UTC)
|1=
This was a suggestion of [[User:TheWWRNerdGuy]].

This setting causes compatibility issues with other extensions such as TextExtracts (see [https://github.com/lkucharczyk/mediawiki-PortableInfobox/issues/17 GitHub issue]). It will soon be set to false by default ([https://github.com/Universal-Omega/PortableInfobox/pull/185 PR]) due to other reasons such as incompatibility with Parsoid.

I am in favor of applying this change only to new wikis. Old wikis should keep the old setting because it is a breaking change and could mess up their CSS (<code>h3</code> becomes <code>div</code>). If we want to apply a breaking HTML change, we should do so when we upgrade MediaWiki when users are expecting breaking changes.

=== Discussion 13a ===
Please discuss disabling this option for all wikis that did not change this option. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:07, 23 April 2026 (UTC)

:{{support|weak}} For reasons said above. If we want to take this route, we should delay the implementation until the next MediaWiki upgrade where breaking changes are expected. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:28, 23 April 2026 (UTC)
:{{support}} if it's going to break with parsoid anyway and disabling it for all wikis is the easier option, I don't see why we don't just kill two birds with one stone. [[User:TheWWRNerdGuy|TheWWRNerdGuy]] ([[User talk:TheWWRNerdGuy|talk]]) 20:28, 23 April 2026 (UTC)
::This issue was raised in [[mediazilla:T363025]]: Parsoid messes with section headings and there was no way to disable that behavior. I don't think the WMF responded to or fixed the issue, but it is not impossible that they somehow address it before MW 1.47. One can dream. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 23:18, 23 April 2026 (UTC)
:::VisualEditor actually [[github:wikimedia/mediawiki/blob/REL1_45/includes/Rest/Handler/Helper/HtmlOutputRendererHelper.php#L786-L811|strips section tags]] already, and given [[wmfphab:T385317]] I feel like there's some hope for section stripping to become configurable, lest we resort to [[github:utdrwiki/PortableInfobox/commit/04f868d|forbidden magic]]. [[User:KockaAdmiralac|KockaAdmiralac]] ([[User talk:KockaAdmiralac|talk]]) 23:39, 23 April 2026 (UTC)
:{{comment}} I was just informed by [[User:Universal Omega]] that PortableInfobox plans to remove this option soon and will default to using <code>div</code> instead of headings. Depending on our update cadence of the extension, this change will reach Miraheze no later than MediaWiki 1.46, which will happen in about 2 to 3 months. Thus, the outcome of this proposal will be less consequential than the others. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 09:06, 24 April 2026 (UTC)
:{{Abstain}} (( ... Skipping ... going way over my head ... )) --- [[User:Imamy|Imamy]] ([[User talk:Imamy|talk]]) 01:56, 25 April 2026 (UTC)
:{{support|strongest}} There is another problem is that TextExtracts treats the {{code|<h2>}} tag within PortableInfoboxes as “real heading within body text.” Consequently, if an extension calling TextExtracts utilizes the parameters {{code|&exintro{{=}}true}} or {{code|&explaintext{{=}}true&exintro{{=}}true}}, the extract will be empty. (such as Popups when {{code|$wgPopupsTextExtractsIntroOnly {{=}} True}}, WikiSEO when {{code|$wgWikiSeoEnableAutoDescription {{=}} True}}).<br>Furthermore, broken CSS is relatively easy to spot and fix, while these issues with TextExtracts are much more difficult to find and fix. --[[User:Maitian MaiLin|Maitian MaiLin]] ([[User talk:Maitian MaiLin|talk]]) 08:00, 30 April 2026 (UTC)
:{{Abstain}} [[User:Harej|Harej]] ([[User talk:Harej|talk]]) 02:09, 1 May 2026 (UTC)
:{{support}} given the incompatibility with both TextExtracts and Parsoid. It appears that we will need to bite this bullet, and I would strongly concur with the general principle espoused by PetraMagna that the best time to do this sort of thing would be alongside a MediaWiki update. — <span style="font-variant: small-caps">[[User:Chrs|chrs]] ([[User talk:Chrs|talk]])</span> 03:22, 1 May 2026 (UTC)
:{{support|weak}} I mean, I wouldn't mind these types of changes for shit that I rarely (or barely) even use, so yeah. --[[User:DarkMatterMan4500|DarkMatterMan4500]] ([[User talk:DarkMatterMan4500|talk]]) ([[Special:Contributions/DarkMatterMan4500|contribs]]) 11:33, 4 May 2026 (UTC)

=== Discussion 13b ===
Please discuss disabling this option only for new wikis. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:07, 23 April 2026 (UTC)

:{{support}} Although <code>$wgPortableInfoboxUseHeadings</code> will likely be removed eventually (due to incompatibilities with Parsoid), it may not happen in the near future, especially since we are uncertain whether Parsoid read view will actually happen on MW 1.47. We should try to not break our wikis if possible, even if it means more work for tech. [[User:PetraMagna|PetraMagna]] ([[User talk:PetraMagna|talk]]) 05:34, 23 April 2026 (UTC)
:{{support}} per proposal - while 13a would make sense, I support the less disruptive way overall. - [[User:JaneBuzJane|JaneBuzJane]] ([[User talk:JaneBuzJane|talk]]) 19:44, 23 April 2026 (UTC)
:{{Oppose}} (( ... I prefer that wiki behavior is consistent regardless of creation date ... )) --- [[User:Imamy|Imamy]] ([[User talk:Imamy|talk]]) 02:00, 25 April 2026 (UTC)
:{{Abstain}} [[User:Harej|Harej]] ([[User talk:Harej|talk]]) 02:09, 1 May 2026 (UTC)
:{{Comment}} We don't use portable infoboxes on our wiki, so this doesn't affect us, which is why I initially abstained, but I figure I might offer my two cents. Since headings are being depreciated in the next MediaWiki upgrade, it makes sense to me to hold off 13a until then, rather than doing it now, but even if it's more work for the tech team ''now'', it might be helpful to disable this option for new wikis, just so you don't get even more people having issues with this once the entire option gets depreciated and you're even more busy fixing all the other bugs that came with the new MediaWiki upgrade. So more work now for less work later. Of course, this is just a suggestion by someone outside looking in, so you don't have to listen to it, especially if the work now would be more taxing than bug-fixing later. [[User:Emiliers|Emiliers]] ([[User talk:Emiliers|talk]]) 01:37, 7 May 2026 (UTC)
:{{Abstain}} Meh. --[[User:DarkMatterMan4500|DarkMatterMan4500]] ([[User talk:DarkMatterMan4500|talk]]) ([[Special:Contributions/DarkMatterMan4500|contribs]]) 17:10, 16 May 2026 (UTC)
}} }}
```
